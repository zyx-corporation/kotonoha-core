...
| `SLS-5.9` Human Review Decision (Phase H) | `human-review-decision-model.md` | **Design gate only** — records human reviewer's approve/reject/request revision/defer decision. External audit record, not automatic engine. [`docs/human-review-decision-model.md`](human-review-decision-model.md). |
